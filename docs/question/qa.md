...
- [3. 面试题-Js方面](#3-面试题-js方面)
  ...
  - [3.2. CMD](#32-cmd)
  - [3.3. UMD](#33-umd)
  - [3.4. ESModule](#34-esmodule)
  - [3.5. this的指向](#35-this的指向)
  - [3.6. call、apply、bind的区别](#36-callapplybind的区别)
  - [3.7. 节流和防抖函数的作用和场景](#37-节流和防抖函数的作用和场景)
  - [3.8. 事件循环](#38-事件循环)
  - [3.9. for in和for of的区别](#39-for-in和for-of的区别)
  - [3.10. 0.1+0.2为什么不等于0.3](#310-0102为什么不等于03)
  - [3.11. 获取url参数](#311-获取url参数)
  - [3.12. 实现一个网络请求模块，要求进行中的网络请求数量不超过10个，超过10个的进入请求队列中，等待前面的请求结束后陆续发送队列中的请求](#312-实现一个网络请求模块要求进行中的网络请求数量不超过10个超过10个的进入请求队列中等待前面的请求结束后陆续发送队列中的请求)
  - [3.13. 实现一下深拷贝cloneDeep](#313-实现一下深拷贝clonedeep)
  - [3.14. 手写一个promise函数](#314-手写一个promise函数)
- [4. 面试题-浏览器方面](#4-面试题-浏览器方面)
  - [4.1. 浏览器渲染机制](#41-浏览器渲染机制)
  - [4.2. Http、Http2、Https的区别](#42-httphttp2https的区别)
  - [4.3. get和post的区别](#43-get和post的区别)
  - [4.4. 常见的状态码](#44-常见的状态码)
  - [4.5. session、local、cookie的区别](#45-sessionlocalcookie的区别)
  - [4.6. 浏览器缓存](#46-浏览器缓存)
    - [4.6.1. 服务端设置缓存](#461-服务端设置缓存)
    - [4.6.2. 前端如何设置资源不缓存](#462-前端如何设置资源不缓存)
  - [4.7. xss跨站脚本攻击](#47-xss跨站脚本攻击)
- [5. 面试题-算法方面](#5-面试题-算法方面)
  - [5.1. 写一个1-100的求和递归](#51-写一个1-100的求和递归)
  - [5.2. 图像旋转算法](#52-图像旋转算法)
  - [5.3. 如何实现一个eventBus？](#53-如何实现一个eventbus)
- [6. 面试题-vue方面](#6-面试题-vue方面)
  - [6.1. MVC、MVP、MVVM的认识](#61-mvcmvpmvvm的认识)
  - [6.2. 生命周期的执行顺序](#62-生命周期的执行顺序)
  - [6.3. 双向绑定数据的原理](#63-双向绑定数据的原理)
  - [6.4. v-if和v-for的优先级哪个更高，如果同时出现，会有什么问题？](#64-v-if和v-for的优先级哪个更高如果同时出现会有什么问题)
  - [6.5. vue的组件data为什么是返回一个函数，根实例则是一个对象？](#65-vue的组件data为什么是返回一个函数根实例则是一个对象)
  - [6.6. v-for中的key作用是什么？](#66-v-for中的key作用是什么)
  - [6.7. 怎么理解vue的diff算法？](#67-怎么理解vue的diff算法)
  - [6.8. 对vue组件化的理解](#68-对vue组件化的理解)
  - [6.9. 组件中的通信方式有哪些？](#69-组件中的通信方式有哪些)
  - [6.10. vue如何扩展现有的组件？](#610-vue如何扩展现有的组件)
  - [6.11. watch和computed的区别](#611-watch和computed的区别)
  - [6.12. nextTick的原理](#612-nexttick的原理)
  - [6.13. vuex的理解](#613-vuex的理解)
  - [6.14. vue-router的钩子函数有哪些？](#614-vue-router的钩子函数有哪些)
  - [6.15. vue的性能优化方法](#615-vue的性能优化方法)
  - [6.16. vue3.x的特性](#616-vue3x的特性)
...
主要用于浏览器端，异步模块定义；通过defined定义模块，require导入模块，推崇依赖前置

defined定义

```js

function defined(id?: string, dependencies?: string[], factory: Function | Object) {}
```
...
### 3.12. 实现一个网络请求模块，要求进行中的网络请求数量不超过10个，超过10个的进入请求队列中，等待前面的请求结束后陆续发送队列中的请求

### 3.13. 实现一下深拷贝cloneDeep
...
### 6.11. watch和computed的区别

### 6.12. nextTick的原理

### 6.13. vuex的理解

### 6.14. vue-router的钩子函数有哪些？
